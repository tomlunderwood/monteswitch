...
all replicas, the results of block averaging from all replicas are combined and stored in the file \texttt{state}. The state stored in state
...
\texttt{interactions\_EC\_NPT.f95}, \and texttt{interactions\_LJ\_hcp\_fcc.f95}. These other files correspond to potentials which we do 
