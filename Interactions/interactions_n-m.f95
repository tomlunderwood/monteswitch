  ...
  ! interactions.f95 file for n-m potential: ( E0 / (npot-mpot) ) * ( mpot*(r0/r)^npot - npot*(r0/r)^mpot )
...
contains
  ...
  subroutine initialise_interactions(filename)
    ...
    !  end if
    !
    read(10,*,iostat=error) string, E0
    if(error/=0) then
        write(0,*) "interactions: Error. Problem reading 'E0' from file '",filename,"'"
        stop 1
    end if
    read(10,*,iostat=error) string, npot
    if(error/=0) then
        write(0,*) "interactions: Error. Problem reading 'npot' from file '",filename,"'"
        stop 1
    end if
    read(10,*,iostat=error) string, mpot
    if(error/=0) then
        write(0,*) "interactions: Error. Problem reading 'mpot' from file '",filename,"'"
        stop 1
    end if
    read(10,*,iostat=error) string, r0
    if(error/=0) then
        write(0,*) "interactions: Error. Problem reading 'r0' from file '",filename,"'"
        stop 1
    end if
    ! <<<<<<<<<<<< END OF USER-DEFINED CODE >>>>>>>>>>>> 
  ...
  subroutine export_interactions_state(unit)
    ...
    !
    write(unit,*) "E0= ",E0
    write(unit,*) "npot= ",npot
    write(unit,*) "mpot= ",mpot
    write(unit,*) "r0= ",r0
    ! <<<<<<<<<<<< END OF USER-DEFINED CODE >>>>>>>>>>>> 
  ...
  subroutine import_interactions_state(unit)
    ...
    !  end if
    !
    read(unit,*,iostat=error) string, E0
    if(error/=0) then
       write(0,*) "interactions: Error. Problem reading 'E0' from unit ",unit
       stop 1
    end if
    read(unit,*,iostat=error) string, npot
    if(error/=0) then
       write(0,*) "interactions: Error. Problem reading 'npot' from unit ",unit
       stop 1
    end if
    read(unit,*,iostat=error) string, mpot
    if(error/=0) then
       write(0,*) "interactions: Error. Problem reading 'mpot' from unit ",unit
       stop 1
    end if
    read(unit,*,iostat=error) string, r0
    if(error/=0) then
       write(0,*) "interactions: Error. Problem reading 'r0' from unit ",unit
       stop 1
    end if
    ! <<<<<<<<<<<< END OF USER-DEFINED CODE >>>>>>>>>>>> 
  ...
  function pair_potential(r)
    ...
    !
    pair_potential= ( E0 / (npot-mpot) ) * ( mpot*(r0/r)**npot - npot*(r0/r)**mpot )
    ! <<<<<<<<<<<< END OF USER-DEFINED CODE >>>>>>>>>>>> 
